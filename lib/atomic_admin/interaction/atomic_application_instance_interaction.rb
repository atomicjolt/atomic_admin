...
class AtomicAdmin::Interaction::AtomicApplicationInstanceInteraction
  ...
  def get
    [
      ...
      general_settings_interaction,
      configuration_interaction,
      xml_configuration_interaction,
      license_details_interaction,
      trial_details_interaction,
    ]
  end
  ...
  def general_settings_interaction
    sites = Site.all
  ...
  def xml_configuration_interaction
    {
      type: "jsonform",
  ...
  def license_details_interaction
    {
      type: "jsonform",
